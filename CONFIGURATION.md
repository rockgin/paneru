...
| `window_wequalize` | Equalize width between focused window and the one to its left, taking full screen width. If no window to the left, take half width and center. |
